...
setup( name=package_name, version="0.0.0", packages=[package_name], data_files=data_files, install_requires=["setuptools"], zip_safe=True, maintainer="Patrick Creighton", maintainer_email="software@ubcsailbot.org", description="UBC Sailbot's local pathfinding ROS package", license="MIT", tests_require=["pytest"], entry_points={
        "console_scripts": [
