...
class Sailbot(Node):
    ...
    Attributes from subscribers:
        ...
        prev_lp_wp_index: index of the last local waypoint seen. This is the waypoint that has
        been traversed by the boat. Polaris is now moving towards prev_lp_wp_index + 1 index of the
        local path.
