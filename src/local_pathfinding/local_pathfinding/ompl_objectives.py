...
# These soft objective weights sum to 1.0. GoalDirectionObjective is excluded because it
# uses infinite cost as a hard constraint rather than as part of normal path scoring.
WIND_OBJECTIVE_WEIGHT = 0.2
TIME_OBJECTIVE_WEIGHT = 0.30
DEVIATION_OBJECTIVE_WEIGHT = 0.30
SEGMENT_COUNT_OBJECTIVE_WEIGHT = 0.2
