...
import { downloadGPSData, downloadAISShipsData, downloadGlobalPathData, downloadLocalPathData, downloadBatteriesData, downloadWindSensorsData, downloadGenericSensorsData
...
class RayeContainer extends React.Component {
  render() {
    ...
    const customContents = [
      { data: ["GPS", "12 hours", "JSON"], action: downloadGPSData },
      { data: ["AIS Ships", "12 hours", "JSON"], action: downloadAISShipsData },
      { data: ["Global Path", "12 hours", "JSON"], action: downloadGlobalPathData },
      { data: ["Local Path", "12 hours", "JSON"], action: downloadLocalPathData },
      { data: ["Batteries", "12 hours", "JSON"], action: downloadBatteriesData },
      { data: ["Wind Sensors", "12 hours", "JSON", "Download"], action: downloadWindSensorsData },
      { data: ["Generic Sensors", "12 hours", "JSON", "Download"], action: downloadGenericSensorsData }
    ];
        ...
        <DataSetsContainer>
          ...
          {customContents.map((content, index) => (
            <AccordionWrapper key={index}>
              <CustomAccordion title={`Download Data Set ${index + 1}`}
