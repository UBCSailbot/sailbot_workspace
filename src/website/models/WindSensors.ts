...
export default (mongoose.models['WindSensors'] as mongoose.Model<WindSensors> | undefined) ?? mongoose.model<WindSensors>('WindSensors', WindSensorsSchema, 'wind_sensors');
