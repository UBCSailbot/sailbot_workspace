...
echo "alias srcraye='unset ROS_DISTRO; source $ROS1_WORKSPACE/devel/setup.bash; echo \"sourcing the underlay and overlay for $ROS1_WORKSPACE\"'" >> $HOME/.bashrc
...
echo "fi" >> $HOME/.bashrc
echo "alias srcnew='unset ROS_DISTRO; source $ROS2_WORKSPACE/install/local_setup.bash; PYTHONPATH=/opt/ros/$ROS2_DISTRO/lib/python3.6/site-packages:\$PYTHONPATH; echo \"sourcing the overlay for $ROS2_WORKSPACE\"'" >> $HOME/.bashrc
